...
public class Allowed_ {
    ...
    public Allowed_ withManual(Integer manual) {
        this.manual = manual;
        return this;
    }
    ...
    public Allowed_ withMac(Integer mac) {
        this.mac = mac;
        return this;
    }
    ...
    public Allowed_ withOverall(Integer overall) {
        this.overall = overall;
        return this;
    }
    ...
    public Allowed_ withRealDevice(Integer realDevice) {
        this.realDevice = realDevice;
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Allowed_) == false) {
            return false;
        }
        Allowed_ rhs = ((Allowed_) other);
