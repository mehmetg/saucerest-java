...
public class ConcurrencyLimit {
    ...
    public ConcurrencyLimit withMac(Integer mac) {
        this.mac = mac;
        return this;
    }
    ...
    public ConcurrencyLimit withScout(Integer scout) {
        this.scout = scout;
        return this;
    }
    ...
    public ConcurrencyLimit withOverall(Integer overall) {
        this.overall = overall;
        return this;
    }
    ...
    public ConcurrencyLimit withRealDevice(Integer realDevice) {
        this.realDevice = realDevice;
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ConcurrencyLimit) == false) {
            return false;
        }
        ConcurrencyLimit rhs = ((ConcurrencyLimit) other);
